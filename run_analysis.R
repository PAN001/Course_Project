clean_data <- function() {
  ...
  ## get the working directory and set the directory
  wd <- getwd()
  ...
  ## Step 1: merge test_set and train_set into one table called sets
  sets <- rbind(test_set, train_set)
  
  ## Step 2: extract any measurements related to mean and std
  ...
  ## Step 3: merge the two acticity tables and add merge them into first_extract
